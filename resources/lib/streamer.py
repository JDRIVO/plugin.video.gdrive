...
#			 self.send_header('Content-Length', response.info().get('Content-Length') )
		...
		# redirect url to output
			...
			self.send_response(200)
			self.end_headers()
			self.wfile.write(b'<html><body><br/><form action="/enroll?default=false" method="post">Client ID:<br /><input type="text" name="client_id" value=""><br />Client Secret:<br /><input type="text" name="client_secret" value=""><br/><br/><input type="submit" value="Submit"></form></body></html>')
			return